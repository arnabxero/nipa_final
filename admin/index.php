        ...
        <div class="col-md-6 col-lg-6">
          ...
          ?>
            <a href="add-category.php">
              <div class="widget-small info coloured-icon"><i class="icon fa fa-files-o fa-2x"></i>
                <div class="info">
        ...
        <div class="col-md-6 col-lg-6">
          ...
          ?>
            <a href="add-package.php">
              <div class="widget-small primary coloured-icon"><i class="icon fa fa-files-o fa-2x"></i>
                <div class="info">
        ...
        <div class="col-md-6 col-lg-6">
          ...
          ?>
              ...
              <a href="manage-post.php">
                <div class="widget-small primary coloured-icon"><i class="icon fa fa-file fa-2x"></i>
                  <div class="info">
        ...
        <div class="col-md-6 col-lg-6">
          ...
          ?>
            <a href="booking-history.php">
              <div class="widget-small info coloured-icon"><i class="icon fa fa-users fa-2x"></i>
                <div class="info">
        ...
        <div class="col-md-6 col-lg-6">
          ...
          ?>
            <a href="new-bookings.php">
              <div class="widget-small danger coloured-icon"><i class="icon fa fa-user fa-2x"></i>
                <div class="info">
                  <h4>New Bookings</h4>
                  <p><b><?php echo $result->totalbookings; ?></b></p>
                </div>
        ...
        <div class="col-md-6 col-lg-6">
          ...
          ?>
            <a href="partial-payment-bookings.php">
              <div class="widget-small warning coloured-icon"><i class="icon fa fa-user fa-2x"></i>
                <div class="info">
