...
<html lang="zxx">
<head>
	<title>NEUB Sports Club Management Systems</title>
	<meta charset="UTF-8">
			...
			<div class="footer-bottom">
				<div class="row">
					...
					<div class="col-md-8 text-md-right">
						<div class="copyright"> 
Copyright All rights reserved | NEUB Sports Club Management Systems <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a></div>
					</div>
				</div>
			</div>
		</div>
